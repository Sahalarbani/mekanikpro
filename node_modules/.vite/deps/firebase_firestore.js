...
(function() {
        ...
        a: {
          ...
          if (!(k2 < 3) && (k2 != 3 || this.g && (this.h.h || this.g.la() || Ib(this.g)))) {
            ...
            if (this.o) {
              ...
              Rb(this.g), b2 == 400 && c.indexOf("Unknown SID") > 0 ? (this.m = 3, J2(12)) : (this.m = 0, J2(13)), Q2(this), Mb(this);
          }
        }
    } catch (k2) {
    } finally {
  ...
  T.prototype.toString = function() {
    ...
    var c = this.g;
    if (c || b2 == "file")
      a.push("//"), (b2 = this.o) && a.push(qc(b2, rc, true), "@"), a.push(L2(c).replace(/%25([0-9a-fA-F]{2})/g, "%$1")), c = this.u, c != null && a.push(":", String(c));
    if (c = this.h)
  ...
  async runTransaction(e, t, n, r) {
    ...
    for (; ; ) {
      ...
      try {
        ...
        if (__PRIVATE_logDebug(L, "Transaction failed with error:", t2.message, "Retrying:", n2), this.close(), !n2)
...
var __PRIVATE_IndexBackfiller = class {
  ...
  se(e, t) {
    ...
    return PersistencePromise.doWhile(() => true === i && r > 0, () => this.localStore.indexManager.getNextCollectionGroupToUpdate(e).next((t2) => {
      if (null !== t2 && !n.has(t2))
        return __PRIVATE_logDebug(K, `Processing collection: ${t2}`), this.oe(e, t2, r).next((e2) => {
          r -= e2, n.add(t2);
        });
      i = false;
    })).next(() => t - r);
...
function __PRIVATE_decodeResourcePath(e) {
  ...
  if (__PRIVATE_hardAssert(t >= 2, 64408, {
    ...
    return __PRIVATE_hardAssert(e.charAt(0) === U && "" === e.charAt(1), 56145, {
      path: e
  ...
  switch (n) {
    ...
    case 11:
      return function __PRIVATE_compareMaps(e2, t2) {
        if (e2 === _t.mapValue && t2 === _t.mapValue)
          return 0;
        if (e2 === _t.mapValue)
          return 1;
        if (t2 === _t.mapValue)
...
var __PRIVATE_FirestoreIndexValueWriter = class {
  ...
  Ct(e, t) {
    if ("nullValue" in e)
      ...
      "mapValue" in e ? __PRIVATE_isMaxValue(e) ? this.Ft(t, Number.MAX_SAFE_INTEGER) : __PRIVATE_isVectorValue(e) ? this.kt(e.mapValue, t) : (this.qt(e.mapValue, t), this.Nt(t)) : "arrayValue" in e ? (this.Kt(e.arrayValue, t), this.Nt(t)) : fail(19022, {
        Ut: e
      });
  }
  Ot(e, t) {
...
var __PRIVATE_IndexedDbIndexManager = class {
  ...
  Gn(e, t) {
    ...
    if (null != i) {
      ...
      n = n.add(new __PRIVATE_IndexEntry(t.indexId, e.key, wt, r));
    return n;
  }
  /**
...
var __PRIVATE_MemoryMutationQueue = class {
  ...
  addMutationBatch(e, t, n, r) {
    ...
    for (const t2 of r)
      this.Hr = this.Hr.add(new __PRIVATE_DocReference(t2.key, i)), this.indexManager.addToCollectionParentIndex(e, t2.key.path.popLast());
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  ...
  runTransaction(e, t, n) {
    ...
    return this.Ki.runTransaction(e, r, i, (r2) => (s = new __PRIVATE_IndexedDbTransaction(r2, this.ai ? this.ai.next() : __PRIVATE_ListenSequence.ce), "readwrite-primary" === t ? this.ji(s).next((e2) => !!e2 || this.Ji(s)).next((t2) => {
      if (!t2)
        throw __PRIVATE_logError(`Failed to obtain primary lease for action '${e}'.`), this.isPrimary = false, this.Ci.enqueueRetryable(() => this.ki(false)), new FirestoreError(D.FAILED_PRECONDITION, B);
      return n(s);
  ...
  Ps(e) {
    return __PRIVATE_primaryClientStore(e).get(Q).next((e2) => {
      if (null !== e2 && this.ts(e2.leaseTimestampMs, Mt) && !this.ss(e2.ownerId) && !this.Xi(e2) && !(this.Mi || this.allowTabSynchronization && e2.allowTabSynchronization))
        throw new FirestoreError(D.FAILED_PRECONDITION, xt);
    });
  }
  /**
...
var __PRIVATE_WebStorageSharedClientState = class {
  ...
  Js(e) {
    ...
    if (t.storageArea === this.storage) {
      if (__PRIVATE_logDebug(qt, "EVENT", t.key, t.newValue), t.key === this.Xs)
  ...
  async mo(e) {
    if (e.user.uid === this.currentUser.uid)
      return this.syncEngine.bo(e.batchId, e.state, e.error);
...
var __PRIVATE_BundleLoader = class {
  ...
  Ga(e) {
    ...
    if (e.Ka.namedQuery)
      ...
      e.Ka.document && (this.Qa[this.Qa.length - 1].document = e.Ka.document, ++t);
...
async function __PRIVATE_syncEngineUnlisten(e, t, n) {
  ...
  if (s.length > 1)
    return r.Eu.set(i.targetId, s.filter((e2) => !__PRIVATE_queryEquals(e2, t))), void r.Tu.delete(t);
...
var __PRIVATE_BundleReaderSyncImpl = class {
  ...
  Uu(e) {
    if (this.cursor + e > this.bundleData.length)
      throw new FirestoreError(D.INTERNAL, "Reached the end of bundle when more is expected.");
...
var FirestoreSettingsImpl = class {
  constructor(e) {
    if (void 0 === e.host) {
      ...
      this.host = e.host, this.ssl = e.ssl ?? nn;
...
function initializeFirestore(e, t, n) {
  ...
  if (void 0 !== t.cacheSizeBytes && -1 !== t.cacheSizeBytes && t.cacheSizeBytes < Ct)
    throw new FirestoreError(D.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
...
function __PRIVATE_parseData(e, t) {
  ...
  if (e instanceof FieldValue)
    return function __PRIVATE_parseSentinelFieldValue(e2, t2) {
      if (!__PRIVATE_isWrite(t2.dataSource))
        throw t2.yc(`${e2._methodName}() can only be used with update() and set()`);
      if (!t2.path)
        throw t2.yc(`${e2._methodName}() is not currently supported inside arrays`);
  ...
  return function __PRIVATE_parseScalarValue(e2, t2) {
    ...
    if (e2 instanceof DocumentReference) {
      ...
      if (!r.isEqual(n))
        throw t2.yc(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);
      return {
          ...
          fields: {
            ...
            [ut]: {
              arrayValue: {
                values: n.map((e4) => {
                  if ("number" != typeof e4)
                    throw t3.yc("VectorValues must only contain numeric values.");
    ...
    return function __PRIVATE_newQueryBoundFromFields(t2, e2, n2, r2, s2, a) {
      ...
      for (let a2 = 0; a2 < s2.length; a2++) {
        ...
        if (o[a2].field.isKeyField()) {
          if ("string" != typeof c)
            throw new FirestoreError(D.INVALID_ARGUMENT, `Invalid query. Expected a string for document ID in ${r2}(), but got a ${typeof c}`);
          if (!__PRIVATE_isCollectionGroupQuery(t2) && -1 !== c.indexOf("/"))
            throw new FirestoreError(D.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by documentId(), the value passed to ${r2}() must be a plain document ID, but '${c}' contains a slash.`);
...
function __PRIVATE_validateQueryFilterConstraint(t, e) {
  if (!(e instanceof QueryFieldFilterConstraint || e instanceof QueryCompositeFilterConstraint))
    throw new FirestoreError(D.INVALID_ARGUMENT, `Function ${t}() requires AppliableConstraints created with a call to 'where(...)', 'or(...)', or 'and(...)'.`);
}
...
function documentSnapshotFromJSON(t, e, n) {
  if (__PRIVATE_validateJSON(e, DocumentSnapshot._jsonSchema)) {
    if (e.bundle === zt2)
      throw new FirestoreError(D.INVALID_ARGUMENT, "The provided JSON object was created in a client environment, which is not supported.");
    ...
    const i = o.documents;
    if (1 !== i.length)
      throw new FirestoreError(D.INVALID_ARGUMENT, `Expected bundle data to contain 1 document, but it contains ${i.length} documents.`);
...
function querySnapshotFromJSON(t, e, n) {
  if (__PRIVATE_validateJSON(e, QuerySnapshot._jsonSchema)) {
    ...
    if (1 !== o.queries.length)
      throw new FirestoreError(D.INVALID_ARGUMENT, `Snapshot data expected 1 query but found ${o.queries.length} queries.`);
...
function onSnapshot(t, ...e) {
  ...
  if (t instanceof DocumentReference)
    i = __PRIVATE_cast(t.firestore, Firestore), c = __PRIVATE_newQueryForPath(t._key.path), o = {
      next: (n2) => {
...
function onSnapshotResume(t, e, ...n) {
  ...
  if (s.error)
    throw new FirestoreError(D.INVALID_ARGUMENT, s.error);
  let a, o = 0;
...
function __PRIVATE_tryGetString(t, e) {
  if ("string" != typeof t[e])
    throw new FirestoreError(D.INVALID_ARGUMENT, "Missing string value for: " + e);
  return t[e];
}
